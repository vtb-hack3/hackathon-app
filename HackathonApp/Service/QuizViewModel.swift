...
let localQuizzes: [Quiz] = [
    .init(
        id: 0,
        text: "Начнем с азов. В чем основная проблема и угроза активных инвестиций в акции? 1",
        answers: [
            .init(
                id: 0,
                text: "1 Нужно тратить время на изучение акций и управление портфелем: постоянно обновлять анализ, следить за новостями и проводить ребалансировку",
                is_right: true,
    ...
    .init(
        id: 1,
        text: "Начнем с азов. В чем основная проблема и угроза активных инвестиций в акции? 2",
        answers: [
            .init(
                id: 0,
                text: "2 Нужно тратить время на изучение акций и управление портфелем: постоянно обновлять анализ, следить за новостями и проводить ребалансировку",
                is_right: true,
                description: "На рынке идет жесткая борьба за каждый процент - и, чтобы получать доходность выше, чем по биржевым фондам, придется подробно изучать, как все устроено. Но и этого может не хватить."
            ),
            .init(
    ...
    .init(
        id: 2,
        text: "Начнем с азов. В чем основная проблема и угроза активных инвестиций в акции? 3",
        answers: [
            .init(
                id: 0,
                text: "3 Нужно тратить время на изучение акций и управление портфелем: постоянно обновлять анализ, следить за новостями и проводить ребалансировку",
                is_right: true,
                description: "На рынке идет жесткая борьба за каждый процент - и, чтобы получать доходность выше, чем по биржевым фондам, придется подробно изучать, как все устроено. Но и этого может не хватить."
            ),
            .init(
