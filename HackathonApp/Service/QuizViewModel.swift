...
let localQuizzes: [Quiz] = [
    ...
    .init(
        id: 0,
        text: "Какое место в рейтинге занимает банк ВТБ по активам?",
        answers: [
            .init(
                id: 0,
                text: "1",
    ...
    .init(
        id: 0,
        text: "Распределение инвестируемых или ссужаемых денежных капиталов между различными объектами вложений с целью снижения риска возможных потерь капитала или доходов от него -- это?",
        answers: [
            .init(
                id: 0,
                text: "Диверсификация",
